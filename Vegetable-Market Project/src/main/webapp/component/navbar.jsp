	...
	<nav class="navbar navbar-expand-lg navbar-light bg-success sticky-top">
		<div class="container">
			...
			<a class="navbar-brand d-flex align-items-center" href="index.jsp">
				<img src="<%= request.getContextPath() %>/assets/img/market-logo.avif" width="50" alt="Vegetable Market" class="mr-2">
				<span class="text-white font-weight-bold">Veggie Market</span>
			</a>
			...
			<!-- Cart button (show only if logged in and NOT a vendor) -->
			<%
			if (isLogged != null && isLogged && !isVendor) {
			%>
			<div class="ml-2">
				<a class="btn btn-warning text-dark" href="viewCart">
